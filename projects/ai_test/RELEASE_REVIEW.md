...
- HOLD: the dry run passed and the public API confirms the repository is public with one fork and one open pull request. Collaborator/protection checks require authenticated access; a recoverable mirror backup, fork/PR coordination, explicit force-push approval, complete dependency/SBOM and human provenance review, Windows MFC compilation, and other release checks remain open.
