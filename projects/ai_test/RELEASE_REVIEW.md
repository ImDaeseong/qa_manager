...
- HOLD: the completed source/license commit is published at `31c5aa6`; the rewrite and updated exact-SHA-leased push dry runs passed, and a complete Git bundle was independently restored and verified. The public API confirms the repository is public with one fork and one open pull request. The real rewrite push was not performed: collaborator/protection checks require authenticated access, and fork/PR coordination plus explicit public-default-branch force-push approval remain open. Complete dependency/SBOM and human provenance review, Windows MFC compilation, and other release checks also remain open.
